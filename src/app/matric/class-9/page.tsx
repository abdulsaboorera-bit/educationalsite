...
export const metadata: Metadata = {
  title: "Class 9 (Ninth Grade) - Subjects, Syllabus, Past Papers | PakEdu",
  description: "Complete guide for Class 9 students in Pakistan. All subjects, marks distribution, syllabus, past papers, and preparation resources for Science, Computer Science, and Arts groups.",
  keywords: [
    "class 9", "ninth grade", "class 9 subjects", "class 9 syllabus", "class 9 past papers",
    "class 9 result", "class 9 date sheet", "9th class", "matric class 9",
  ],
  openGraph: {
    title: "Class 9 (Ninth Grade) - Subjects, Syllabus, Past Papers | PakEdu",
    description: "Complete guide for Class 9 students in Pakistan. Subjects, syllabus, past papers, and preparation tips.",
    url: `${SITE_CONFIG.url}/matric/class-9`,
  },
};

const FAQS = [
  { question: "How many subjects are there in Class 9?", answer: "Class 9 has 7-8 subjects depending on the group. Science group has 7 subjects, Computer Science group has 6 subjects, and Arts group has 6 subjects." },
  { question: "What is the total marks for Class 9?", answer: "Total marks vary by group: Science group has 600 marks, Computer Science group has 550 marks, and Arts group has 500 marks." },
  { question: "Is Class 9 exam difficult?", answer: "Class 9 exam difficulty depends on your preparation. With consistent study and practice of past papers, most students can perform well." },
  { question: "When is the Class 9 exam?", answer: "Class 9 annual examinations are typically held in March-April. The exact dates are announced by each board separately." },
];

export default function Class9Page() {
  const class9 = getClassInfo("9");
  const subjectsList = getSubjectsByClass("9");
  const scienceCombo = getCombination("9", "science");
  const csCombo = getCombination("9", "computer_science");
  const artsCombo = getCombination("9", "arts");
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <Breadcrumbs
            items={[{ label: "Home", href: "/" }, { label: "Matric", href: "/matric" }, { label: "Class 9" }]}
            className="text-blue-100/80 [&_a]:text-white/80 [&_a]:hover:text-white"
          />
          <h1 className="text-3xl md:text-4xl font-bold mt-6 mb-4">Class 9 (Ninth Grade)</h1>
          <p className="text-lg text-blue-100/90 max-w-2xl mb-6">
            {class9?.description}
          </p>
          <div className="flex flex-wrap gap-3">
            <Link href="/matric/boards" className="inline-flex items-center gap-2 bg-white text-blue-700 px-5 py-2.5 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
              <FileText className="h-4 w-4" /> Past Papers
            </Link>
            <Link href="/calculators/percentage" className="inline-flex items-center gap-2 bg-blue-500/20 text-white border border-white/30 px-5 py-2.5 rounded-lg font-semibold hover:bg-blue-500/30 transition-colors">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <section className="grid sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            ...
            <div className="text-sm font-medium text-slate-900">{class9?.exam_structure}</div>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            <div className="text-sm text-slate-500 mb-1">Passing Criteria</div>
            <div className="text-sm font-medium text-slate-900">{class9?.passing_criteria}</div>
          </div>
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            <div className="text-sm text-slate-500 mb-1">Total Compulsory Marks</div>
            <div className="text-sm font-medium text-slate-900">{class9?.total_compulsory_marks} marks</div>
          </div>
        </section>
        ...
        {/* All Subjects */}
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-6">All Class 9 Subjects</h2>
