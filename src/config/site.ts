...
export const NAV_ITEMS = [
  ...
  { label: "Intermediate", href: "/intermediate", children: [
    { label: "Intermediate Overview", href: "/intermediate" },
    ...
    { label: "Past Papers", href: "/intermediate/past-papers" },
    { label: "Entry Tests", href: "/intermediate/entry-tests" },
    { label: "Scholarships", href: "/intermediate/scholarships" },
  ]},
